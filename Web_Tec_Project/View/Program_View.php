<?php
	...
	require_once "../Model/Accepted_Data_Details.php";
?>
...
<body>
		...
		<div id="profile">
			...
			<table class="table table-bordered table-hover">
					...
					<tr align="center" id="butt">
						<td colspan="6" id="btn">
							<a class="fcc-btn" href='../View/Volunteer_Details.php?id=<?php echo $program_id; ?>'>See volunteer Details</a>
						</td>
					</tr>
				</tr>
			</table>
